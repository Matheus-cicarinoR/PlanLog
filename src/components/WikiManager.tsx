...
export const WikiManager: React.FC = () => {
  ...
  return (
    <div className="space-y-8 pb-16">
          ...
          <div className="pt-2">
            <div className="relative max-w-xl">
              ...
              <Input
                ...
                className="pl-12 pr-4 py-3 h-12 bg-white/10 dark:bg-slate-950/60 backdrop-blur-md border-slate-600/80 text-white placeholder:text-slate-400 rounded-2xl text-sm focus:border-amber-400 focus:ring-amber-400/20 shadow-inner"
              />
              {searchTerm && (
                <button
        ...
        <div className="space-y-6 animate-scaleUp">
          <div className="flex items-center justify-between">
            <button
              ...
              className="text-xs font-bold text-slate-500 hover:text-slate-900 dark:hover:text-slate-100 flex items-center gap-1.5 cursor-pointer"
            >
          ...
          <Card className="border-slate-200 dark:border-slate-800 shadow-md overflow-hidden">
            <div className="p-6 sm:p-8 bg-slate-50 dark:bg-slate-900/60 border-b border-slate-200 dark:border-slate-800 space-y-3">
            ...
            <CardContent className="p-6 sm:p-8 space-y-6">
              ...
              <div className="space-y-4">
                {activeArticle.steps.map((step, idx) => (
                  <div 
                    key={idx} 
                    className="p-4 sm:p-5 rounded-2xl bg-white dark:bg-slate-900/90 border border-slate-200/80 dark:border-slate-800 shadow-sm space-y-2"
                  >
                    <div className="flex items-center gap-2.5">
                      <span className="w-6 h-6 rounded-full bg-amber-500/20 text-amber-600 dark:text-amber-400 text-xs font-mono font-black flex items-center justify-center border border-amber-500/30">
                        {idx + 1}
                      </span>
                    ...
                    {step.tip && (
                      <div className="ml-8 mt-2 p-3 rounded-xl bg-amber-50 dark:bg-amber-950/30 border border-amber-500/30 text-amber-900 dark:text-amber-300 text-xs flex items-start gap-2">
              ...
              {activeArticle.importantNotes && (
                <div className="p-4 sm:p-5 rounded-2xl bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900/50 space-y-2">
                  <h4 className="font-bold text-xs sm:text-sm text-blue-900 dark:text-blue-300 flex items-center gap-1.5">
                    <AlertTriangle className="w-4 h-4 text-blue-500" />
                    <span>Observações Importantes</span>
                  </h4>
                  <ul className="space-y-1 text-xs sm:text-sm text-blue-800 dark:text-blue-200 list-disc pl-5">
        ...
        <div className="space-y-6">
          ...
          {filteredTutorials.length === 0 ? (
            <div className="text-center py-12 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-8 space-y-3">
              ...
              <h3 className="font-bold text-slate-800 dark:text-slate-200">Nenhum tutorial encontrado</h3>
                ...
                return (
                  ...
                  >
                    <CardContent className="p-5 space-y-3">
                      ...
                      <div className="pt-2 border-t border-slate-100 dark:border-slate-800/60 flex items-center justify-between text-[11px] text-slate-400 font-medium">
            ...
            return (
              ...
              >
                <button
                  ...
                  className="w-full p-4 text-left flex items-start justify-between gap-3 cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors"
                >
                  <div>
                    <span className="text-[10px] font-mono font-bold text-amber-600 dark:text-amber-400 uppercase tracking-wider block mb-0.5">
                      {faq.category}
                    </span>
                ...
                {isOpen && (
                  <div className="px-4 pb-4 pt-1 text-xs sm:text-sm text-slate-600 dark:text-slate-400 leading-relaxed border-t border-slate-100 dark:border-slate-800/80 animate-scaleUp">
                    {faq.answer}
                  </div>
                )}
              </div>
      ...
      {/* DICA DE SUPORTE */}
      <div className="p-6 rounded-3xl bg-gradient-to-r from-amber-500/10 via-slate-100 to-amber-500/5 dark:from-amber-950/30 dark:via-slate-900 dark:to-amber-950/10 border border-amber-500/30 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <Button
          onClick={() => navigate('/')}
          className="bg-slate-900 hover:bg-slate-800 dark:bg-slate-100 dark:hover:bg-white text-white dark:text-slate-900 font-black text-xs px-5 py-2.5 rounded-xl shrink-0"
        >
          Voltar ao Dashboard
        </Button>
      </div>
