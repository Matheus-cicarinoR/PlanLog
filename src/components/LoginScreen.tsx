...
export const LoginScreen: React.FC<LoginScreenProps> = ({ onLoginSuccess }) => {
 ...
 return (
  <div className="min-h-screen bg-slate-50 flex flex-col lg:flex-row relative overflow-hidden selection:bg-amber-400 selection:text-slate-950 font-sans">
   ...
   <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 relative bg-white ">
    ...
    <div className="text-center mb-8 lg:hidden">
     ...
     <h1 className="text-2xl font-black text-slate-900 tracking-wider flex items-center justify-center gap-1.5">
      PlanLog
     </h1>
    ...
    {/* Card Form */}
    <div className="bg-white/50 backdrop-blur-xl lg:bg-transparent lg: lg:backdrop-blur-none rounded-3xl p-6 sm:p-8 border border-slate-200/90 lg:border-none shadow-2xl shadow-black/10 lg:shadow-none space-y-6">
   ...
   {showHelpModal && (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-fadeIn">
     <div className="relative w-full max-w-sm bg-white border border-slate-200 rounded-2xl p-6 shadow-2xl space-y-4">
      ...
      <div className="p-3 rounded-xl bg-slate-100 border border-slate-200 text-xs text-slate-500 space-y-1">
