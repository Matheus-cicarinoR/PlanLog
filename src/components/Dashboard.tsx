...
export const Dashboard: React.FC<DashboardProps> = ({
 ...
 return (
  <div className="space-y-6 pb-12" style={{width: '100%', height: '100%', overflowX: 'hidden'}}>

   {/* Alerta / Status de Manutenção Preventiva de Óleo */}
   {isAllMachinesSelected ? (
    <div className="rounded-2xl bg-blue-50 border border-blue-200 p-4 sm:p-4.5 flex flex-wrap items-center justify-between gap-3 text-blue-700 shadow-sm">
    ...
    <div className="rounded-2xl bg-red-50 border border-red-200 p-4 sm:p-5 flex flex-wrap items-center justify-between gap-4 text-red-900 shadow-sm">
     <div className="flex items-center gap-3.5">
      ...
      <div>
       <div className="flex items-center gap-2">
        <span className="text-[11px] font-black uppercase tracking-wider bg-red-100 text-red-700 px-2 py-0.5 rounded-md">
         Atenção Crítica
        </span>
       ...
       <h4 className="font-extrabold text-red-950 text-sm sm:text-base mt-0.5">
    ...
    <div className="rounded-2xl bg-white border border-slate-200/90 p-4 sm:p-4.5 flex flex-wrap items-center justify-between gap-3 text-slate-700 shadow-xs hover:shadow-md transition-shadow">
     <div className="flex items-center gap-3">
      <div className="p-2.5 rounded-xl bg-emerald-50 text-slate-900  shrink-0">
       <CheckCircle2 className="w-5 h-5" />
      </div>
      <div>
       <div className="flex items-center gap-2">
        <span className="text-xs font-semibold text-slate-500 ">Telemetria de Manutenção</span>
        {config?.modelo_maquina && (
     ...
     <div className="flex items-center gap-3">
      <div className="hidden sm:flex flex-col items-end">
       ...
       <span className="text-xs font-black text-slate-900 ">{vidaUtilPercent}% Restante</span>
      </div>
   ...
   <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
    ...
    <MetricCard
     ...
     subtext={
      <div className="flex items-center justify-between w-full text-xs">
       <span className="text-slate-500 ">{servicos.length} serviços registrados</span>
       <span className="text-slate-900 font-bold">{formatHours(totalHorasTrabalhadas)} total</span>
      </div>
     }
    />
    ...
    >
     <MetricCard
      ...
      className="h-full border-red-200/90 hover:border-red-300"
      icon={<AlertTriangle className="w-5 h-5" />}
      
      subtext={
       <div className="flex items-center justify-between w-full text-xs text-red-600 ">
   ...
   <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 items-stretch">
    ...
    <Card className="flex flex-col">
     <CardHeader className="flex flex-row items-center justify-between pb-3 mb-2 border-b border-slate-200 h-[56px] gap-2">
      ...
      <div className="space-y-3">
       ...
       <div className="flex items-center justify-between p-3 rounded-xl bg-slate-100 border border-slate-200 "> 
        <div className="flex items-center gap-3"> 
         ...
         <div>
          <h4 className="text-sm font-bold text-slate-900 ">Manutenção & Peças</h4>
          <p className="text-xs text-slate-500 ">{manutencoes.length} registros cadastrados</p>
         </div>
        </div>
        <span className="text-sm font-bold text-orange-600 shrink-0 whitespace-nowrap pl-2">
       ...
       <div className="flex items-center justify-between p-3 rounded-xl bg-slate-100 border border-slate-200 ">
        <div className="flex items-center gap-3">
         ...
         <div>
          <h4 className="text-sm font-bold text-slate-900 ">Diesel S10</h4>
          <p className="text-xs text-slate-500 ">{totalLitrosDiesel.toFixed(0)}L total (~{consumoMedioDiesel.toFixed(1)} L/h)</p>
         </div>
        </div>
        <span className="text-sm font-bold text-slate-900 shrink-0 whitespace-nowrap pl-2">
       ...
       <div className="flex items-center justify-between p-3 rounded-xl bg-slate-100 border border-slate-200 ">
        <div className="flex items-center gap-3">
         ...
         <div>
          <h4 className="text-sm font-bold text-slate-900 ">Mão de Obra</h4>
          <p className="text-xs text-slate-500 ">Operadores e ajuda de custo</p>
         </div>
        </div>
        <span className="text-sm font-bold text-blue-600 shrink-0 whitespace-nowrap pl-2">
    ...
    <Card className="flex flex-col">
     <CardHeader className="flex flex-row items-center justify-between pb-3 mb-2 border-b border-slate-200 h-[56px] gap-2">
      ...
      <span className="text-xs text-slate-900 font-bold shrink-0 whitespace-nowrap">100% Auditável</span>
     </CardHeader>
     <CardContent className="space-y-3 pt-0 flex-1 flex flex-col justify-between">
      <div className="space-y-2.5">
       ...
       <div className="p-2.5 rounded-xl bg-slate-100 border border-slate-200 flex items-center justify-between text-xs">
        <div className="flex items-center gap-2">
         ...
         <span className="text-slate-700 font-semibold">PIX Direto na Conta</span>
        </div>
        <span className="font-bold text-slate-900 ">{formatCurrency(totalPix)}</span>
       </div>
       ...
       <div className="p-2.5 rounded-xl bg-slate-100 border border-slate-200 flex items-center justify-between text-xs">
        <div className="flex items-center gap-2">
         ...
         <span className="text-slate-700 font-semibold">Cartão de Crédito/Débito</span>
        </div>
        <span className="font-bold text-purple-600 ">{formatCurrency(totalCartao)}</span>
       </div>
       ...
       <div className="p-2.5 rounded-xl bg-slate-100 border border-slate-200 flex items-center justify-between text-xs">
        <div className="flex items-center gap-2">
         ...
         <span className="text-slate-700 font-semibold">Dinheiro (Erica)</span>
        </div>
        <span className="font-bold text-blue-600 ">{formatCurrency(2226.0)}</span>
       </div>
       ...
       <div className="p-2.5 rounded-xl bg-slate-100 border border-slate-200 flex items-center justify-between text-xs">
        <div className="flex items-center gap-2">
         ...
         <span className="text-slate-700 font-semibold">Dinheiro (Jurandir)</span>
        </div>
        <span className="font-bold text-slate-900 ">{formatCurrency(400.0)}</span>
       </div>
      </div>
      ...
      <Button
       ...
       className="w-full mt-2 cursor-pointer text-xs"
      >
       <Users className="w-3.5 h-3.5 text-slate-900 mr-2" />
    ...
    <Card className="flex flex-col border-red-200/80 ">
     <CardHeader className="flex flex-row items-center justify-between pb-3 mb-2 border-b border-slate-200 h-[56px] gap-2">
      <div className="flex items-center gap-2 min-w-0">
       <ShieldAlert className="w-4 h-4 text-slate-900 shrink-0" />
       <CardTitle className="text-sm font-bold text-red-600 truncate">Cobrança Rápida</CardTitle>
      </div>
     ...
     <CardContent className="pt-0 flex-1 flex flex-col justify-between">
      {servicosPendentes.length === 0 ? (
       ...
       <div className="space-y-2 max-h-[300px] overflow-y-auto pr-1">
        {servicosPendentes.map((servico) => (
         <div
          key={servico.id}
          className="p-3 rounded-xl bg-slate-100 border border-slate-200 hover:border-red-300 transition-all flex items-center justify-between gap-3"
         >
          <div className="min-w-0">
           <div className="flex items-center gap-1.5">
            <span className="font-bold text-xs sm:text-sm text-slate-900 truncate">{servico.cliente}</span>
           ...
           <div className="flex items-center gap-2 text-xs mt-0.5">
            ...
            {servico.status === 'parcial' && (
             <span className="text-[10px] text-slate-900 bg-amber-50  px-1.5 py-0.2 rounded-md font-bold">
              Parcial
             </span>
            )}
           </div>
          ...
          <div className="flex items-center gap-1.5 shrink-0">
           ...
           <Button
            ...
            className="h-7 w-7 text-slate-900 border-emerald-200 hover:bg-emerald-50  cursor-pointer"
           >
      ...
      <Button
       ...
       className="w-full mt-2 cursor-pointer text-xs"
      >
       <AlertTriangle className="w-3.5 h-3.5 text-slate-900 mr-2" />
