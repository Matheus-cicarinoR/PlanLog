...
export const ServiceModal: React.FC<ServiceModalProps> = ({
 ...
 return (
  <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/75 backdrop-blur-sm animate-fadeIn">
   {/* Modal Card Centered */}
   <div className="bg-white border border-slate-200 rounded-2xl w-full max-w-3xl max-h-[92vh] flex flex-col shadow-2xl overflow-hidden animate-scaleUp">
    
    {/* Fixed Header with Mode Switch */}
    <div className="p-4 sm:p-5 border-b border-slate-200 flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-slate-50 shrink-0">
    ...
    <form onSubmit={handleSubmit} className="flex flex-col flex-1 overflow-hidden">
     <div className="p-5 sm:p-6 space-y-4 overflow-y-auto custom-scrollbar flex-1 text-xs sm:text-sm">
      ...
      {isDeslocamento && (
       <div className="p-3.5 rounded-xl bg-blue-50 border border-blue-500/30 flex items-start gap-2.5 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5">
       ...
       {!isDeslocamento ? (
        <div className="sm:col-span-1">
         <div className="flex items-center justify-between mb-1">
          <label className="text-slate-700 font-bold flex items-center gap-1.5">
           <User className="w-3.5 h-3.5 text-slate-600 " /> Cliente Cadastrado *
          </label>
          <button
           type="button"
           onClick={() => setShowQuickAddClient(!showQuickAddClient)}
           className="text-[11px] font-bold text-slate-600 hover:underline flex items-center gap-0.5 cursor-pointer"
          >
         ...
         {!showQuickAddClient ? (
          <div className="space-y-1">
           <select
            ...
            className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 font-medium focus:outline-none focus:border-slate-400 cursor-pointer"
          ...
          <div className="p-3 rounded-xl bg-slate-100 border border-slate-200 space-y-2 animate-fadeIn">
        ...
        <div className="sm:col-span-1">
         ...
         <div className="w-full px-3 py-2 bg-blue-50 border border-blue-200 rounded-xl text-blue-700 font-bold flex items-center gap-2">
       ...
       <div>
        <label className="block text-slate-700 font-bold mb-1 flex items-center gap-1.5">
         <Tractor className="w-3.5 h-3.5 text-slate-600 " /> Máquina Vinculada *
        </label>
        <select
         value={maquinaId}
         onChange={(e) => {
       ...
       <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-3.5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
         <div>
          ...
          <input
           ...
           className="w-full px-3 py-2 bg-white border border-slate-200 rounded-lg text-slate-700 font-mono font-bold text-base focus:outline-none focus:border-slate-400 transition-colors"
          />
         </div>
         ...
         <div>
          ...
          <input
           ...
           className="w-full px-3 py-2 bg-white border border-slate-200 rounded-lg text-slate-900 font-mono font-bold text-base focus:outline-none focus:border-slate-400 transition-colors"
          />
         </div>
         ...
         <div>
          ...
          <input
           ...
           className="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-slate-900 font-mono font-bold text-base focus:outline-none focus:border-slate-400 transition-colors"
          />
         </div>
        </div>
        ...
        <div className="pt-3 border-t border-slate-200 ">
         <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 mb-2">
          ...
          <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-blue-50 text-blue-600 border border-blue-500/20 inline-flex items-center gap-1 w-fit">
          ...
          <div>
           <div className="flex items-center gap-2">
            <input
             ...
             className="w-full px-3 py-2 bg-white border border-slate-200 rounded-lg text-blue-600 font-mono font-bold text-sm focus:outline-none focus:border-blue-400"
            />
            <span className="text-xs font-bold text-slate-500 shrink-0">horas</span>
           </div>
          </div>

          <div className="text-[11px] text-slate-500 bg-white p-2 rounded-lg border border-slate-200 flex items-center justify-between">
         ...
         <div>
          ...
          <div className="flex items-center gap-2">
           <input
            ...
            placeholder="Ex: 1.5"
            className="w-full px-3 py-2 bg-white border border-blue-300 rounded-lg text-blue-600 font-mono font-bold text-base focus:outline-none focus:border-blue-400"
           />
           <span className="text-xs font-bold text-slate-500 shrink-0">horas</span>
          </div>
         </div>

         <div className="text-[11px] text-slate-500 bg-white p-2.5 rounded-lg border border-blue-200 ">
          <p className="font-semibold text-slate-700 mb-0.5">Impacto no Sistema:</p>
      ...
      {!isDeslocamento && (
       <>
         ...
         <div className="grid grid-cols-3 gap-2">
          <button
           ...
           className={`py-2 px-3 rounded-xl border text-xs font-bold transition-all flex items-center justify-center gap-1.5 cursor-pointer ${
            status === 'pago'
             ? 'bg-emerald-50 text-emerald-600 border-emerald-500/30 shadow-sm'
          ...
          <button
           ...
           className={`py-2 px-3 rounded-xl border text-xs font-bold transition-all flex items-center justify-center gap-1.5 cursor-pointer ${
            status === 'pendente'
             ? 'bg-red-50 text-red-600 border-red-500/30 shadow-sm'
             : 'bg-slate-50 text-slate-500 border-slate-200 hover:bg-slate-100'
           }`}
          >
        ...
        {status === 'parcial' && (
         <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 grid grid-cols-2 gap-3 animate-fadeIn">
          <div>
           ...
           <input
            ...
            className="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-emerald-600 font-mono font-bold focus:outline-none focus:border-slate-400 transition-colors"
           />
          </div>
          ...
          <div>
           ...
           <div className="px-3 py-2 bg-white border border-red-500/30 rounded-lg text-red-500 font-mono font-bold flex items-center h-[38px]">
     ...
     <div className="flex items-center justify-between px-5 py-3.5 sm:px-6 bg-slate-50 border-t border-slate-200 shrink-0">
      <div className="text-xs">
       ...
       <span className={`text-base font-black font-mono ${isDeslocamento ? 'text-blue-600 ' : 'text-slate-700 '}`}>
      ...
      <div className="flex items-center gap-2">
       <button
        type="button"
        onClick={onClose}
        className="px-4 py-2 rounded-xl bg-slate-100 text-slate-600 font-semibold text-xs hover:bg-slate-200 cursor-pointer"
       >
        Cancelar
       </button>
       <button
