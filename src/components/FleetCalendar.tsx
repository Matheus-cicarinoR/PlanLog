...
export const FleetCalendar: React.FC<FleetCalendarProps> = ({
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-3.5 sm:p-6 shadow-sm">
        <div>
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-lg sm:text-2xl font-black text-slate-900 dark:text-slate-100 flex items-center gap-2 flex-wrap">
                Agenda da Frota
                <Badge variant="outline" className="text-xs bg-amber-50 dark:bg-amber-500/10 text-amber-600 dark:text-amber-400 border-amber-500/30">
        ...
        <div className="flex flex-wrap items-center gap-2 sm:gap-2.5 w-full lg:w-auto justify-between lg:justify-end">
          ...
          <div className="w-full sm:w-auto">
            <select
              ...
              className="w-full sm:w-auto bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-xs font-bold text-slate-800 dark:text-slate-200 focus:outline-none focus:border-amber-500/50 cursor-pointer"
            >
          ...
          <div className="flex items-center bg-slate-100 dark:bg-slate-800 rounded-xl p-1 border border-slate-200 dark:border-slate-700">
            ...
            <button
              onClick={handleToday}
              className="px-2.5 py-1 text-xs font-bold text-slate-700 dark:text-slate-200 hover:text-amber-500 transition-colors"
            >
              Hoje
            </button>
            <button
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-3.5">
        <div className="p-3 sm:p-4 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm flex items-center gap-2.5 sm:gap-3">
          <div className="p-2 sm:p-2.5 rounded-xl bg-blue-50 dark:bg-blue-500/10 text-blue-600 dark:text-blue-400 border border-blue-500/20 shrink-0">
            <Tractor className="w-4 h-4 sm:w-5 sm:h-5" />
          </div>
          <div className="min-w-0 flex-1">
            <span className="text-[10px] sm:text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider block truncate">Serviços no Mês</span>
            <div className="flex items-baseline gap-1 sm:gap-1.5 flex-wrap">
              <span className="text-base sm:text-lg font-black text-slate-900 dark:text-slate-100 font-mono">{monthStats.countServicos}</span>
              <span className="text-[11px] sm:text-xs text-blue-600 dark:text-blue-400 font-semibold font-mono">({formatHours(monthStats.horasServicos)})</span>
            </div>
          </div>
        </div>

        <div className="p-3 sm:p-4 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm flex items-center gap-2.5 sm:gap-3">
          <div className="p-2 sm:p-2.5 rounded-xl bg-emerald-50 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20 shrink-0">
            <DollarSign className="w-4 h-4 sm:w-5 sm:h-5" />
          </div>
          <div className="min-w-0 flex-1">
            <span className="text-[10px] sm:text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider block truncate">Faturamento Prev.</span>
            <span className="text-sm sm:text-lg font-black text-emerald-600 dark:text-emerald-400 font-mono block truncate">{formatCurrency(monthStats.faturamentoServicos)}</span>
          </div>
        </div>

        <div className="p-3 sm:p-4 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm flex items-center gap-2.5 sm:gap-3">
          <div className="p-2 sm:p-2.5 rounded-xl bg-purple-50 dark:bg-purple-500/10 text-purple-600 dark:text-purple-400 border border-purple-500/20 shrink-0">
            <Wrench className="w-4 h-4 sm:w-5 sm:h-5" />
          </div>
          <div className="min-w-0 flex-1">
            <span className="text-[10px] sm:text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider block truncate">Manutenções</span>
            <div className="flex items-baseline gap-1 sm:gap-1.5 flex-wrap">
              <span className="text-base sm:text-lg font-black text-slate-900 dark:text-slate-100 font-mono">{monthStats.countManutencoes}</span>
        ...
        <div className="p-3 sm:p-4 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm flex items-center gap-2.5 sm:gap-3">
          <div className="p-2 sm:p-2.5 rounded-xl bg-amber-50 dark:bg-amber-500/10 text-amber-600 dark:text-amber-400 border border-amber-500/20 shrink-0">
            <Layers className="w-4 h-4 sm:w-5 sm:h-5" />
          </div>
          <div className="min-w-0 flex-1">
            <span className="text-[10px] sm:text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider block truncate">Total Atividades</span>
            <div className="flex items-baseline gap-1">
              <span className="text-base sm:text-lg font-black text-slate-900 dark:text-slate-100 font-mono">{monthStats.totalEventos}</span>
      ...
      {/* Filter Chips Bar */}
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2.5 bg-slate-50 dark:bg-slate-900/50 p-2.5 sm:p-3 rounded-xl border border-slate-200 dark:border-slate-800">
      ...
      {viewMode === 'month' && (
        <div className="space-y-4">
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden w-full">
            ...
            <div className="grid grid-cols-7 border-b border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950/60 text-center py-2">
              {weekDayNames.map((d, index) => (
                <div 
                  key={d} 
                  className={`text-[10px] sm:text-xs font-black uppercase tracking-wider ${
                    index === 0 || index === 6 ? 'text-amber-500' : 'text-slate-500 dark:text-slate-400'
                  }`}
                >
            ...
            {/* Days Grid Cells */}
            <div className="grid grid-cols-7 w-full auto-rows-fr divide-x divide-y divide-slate-200 dark:divide-slate-800 border-b border-slate-200 dark:border-slate-800">
                ...
                return (
                  <div
                    ...
                    className={`min-h-[56px] sm:min-h-[135px] p-1 sm:p-2 flex flex-col justify-between transition-colors relative cursor-pointer group ${
                      ...
                      isSelected
                        ? 'ring-2 ring-inset ring-amber-500 bg-amber-50/40 dark:bg-amber-500/10'
                        : dayItem.isToday
                        ? 'ring-1 ring-inset ring-amber-500/60 bg-amber-50/20 dark:bg-amber-500/5'
                  ...
                  >
                          ...
                          <div
                            ...
                            className={`px-1.5 py-1 rounded-md text-[10px] font-bold truncate cursor-pointer transition-all border shadow-2xs flex items-center gap-1 ${
                              s.status === 'pago'
                                ...
                                : s.status === 'parcial'
                                ? 'bg-amber-50 dark:bg-amber-500/10 text-amber-700 dark:text-amber-300 border-amber-300 dark:border-amber-500/30 hover:bg-amber-100'
                                : 'bg-blue-50 dark:bg-blue-500/10 text-blue-700 dark:text-blue-300 border-blue-300 dark:border-blue-500/30 hover:bg-blue-100'
                            }`}
                      ...
                      {dayEvents.manutencoes.map((m) => {
                        ...
                        return (
                          <div
                            ...
                            className={`px-1.5 py-1 rounded-md text-[10px] font-bold truncate cursor-pointer transition-all border shadow-2xs flex items-center gap-1 ${
                              m.status === 'urgente'
                                ? 'bg-red-50 dark:bg-red-500/10 text-red-700 dark:text-red-300 border-red-300 dark:border-red-500/30 hover:bg-red-100 animate-pulse'
                                : m.status === 'concluido'
                                ...
                                : 'bg-purple-50 dark:bg-purple-500/10 text-purple-700 dark:text-purple-300 border-purple-300 dark:border-purple-500/30 hover:bg-purple-100'
                            }`}
                    ...
                    {totalDayCount > 3 && (
                      <span className="hidden sm:block text-[9px] font-bold text-slate-400 dark:text-slate-500 text-right mt-1">
          ...
          <div className="sm:hidden p-3.5 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
                ...
                <div className="space-y-2">
                  {dayEvents.servicos.map((s) => (
                    <div
                      ...
                      className="p-3 rounded-xl bg-slate-50 dark:bg-slate-800/70 border border-slate-200 dark:border-slate-700 flex items-center justify-between cursor-pointer active:scale-[0.99] transition-transform"
                    >
                      <div className="flex items-center gap-2.5">
                        <span className="text-lg">🚜</span>
                        <div>
                          <h5 className="font-bold text-xs text-slate-900 dark:text-slate-100">{s.cliente}</h5>
                  ...
                  {dayEvents.manutencoes.map((m) => (
                    ...
                    >
                      <div className="flex items-center gap-2.5">
                        <span className="text-lg">🔧</span>
                        <div>
                          <h5 className="font-bold text-xs text-slate-900 dark:text-slate-100">{m.titulo}</h5>
                          <span className="text-[10px] text-purple-600 dark:text-purple-400 capitalize font-medium">
                            {m.tipo.replace('_', ' ')}
                          </span>
                        </div>
                      </div>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm p-4 sm:p-6 space-y-4">
          ...
          {upcomingEvents.length === 0 ? (
            <div className="text-center py-12">
              ...
              <h4 className="font-bold text-slate-800 dark:text-slate-200">Nenhum evento agendado</h4>
              ...
              {upcomingEvents.map((item, idx) => {
                ...
                return (
                  <div
                    ...
                    className="p-4 rounded-xl border border-slate-200 dark:border-slate-800 hover:border-amber-500/40 bg-slate-50/50 dark:bg-slate-800/30 hover:bg-amber-50/10 dark:hover:bg-amber-500/5 transition-all flex flex-col sm:flex-row sm:items-center justify-between gap-4 cursor-pointer"
                  >
                    <div className="flex items-start sm:items-center gap-3.5">
                      <div className={`p-3 rounded-xl shrink-0 ${
                        isServico 
                          ? 'bg-blue-50 dark:bg-blue-500/10 text-blue-600 dark:text-blue-400 border border-blue-500/20' 
                          : 'bg-purple-50 dark:bg-purple-500/10 text-purple-600 dark:text-purple-400 border border-purple-500/20'
                      }`}>
                      ...
                      <div>
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${
                            isServico
                              ? svc?.status === 'pago' ? 'bg-emerald-100 dark:bg-emerald-500/20 text-emerald-700 dark:text-emerald-300' : 'bg-amber-100 dark:bg-amber-500/20 text-amber-700 dark:text-amber-300'
                              : mnt?.status === 'concluido' ? 'bg-emerald-100 dark:bg-emerald-500/20 text-emerald-700 dark:text-emerald-300' : 'bg-purple-100 dark:bg-purple-500/20 text-purple-700 dark:text-purple-300'
                          }`}>
      ...
      {isScheduleModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fadeIn">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl w-full max-w-lg overflow-hidden shadow-2xl animate-scaleUp max-h-[90vh] flex flex-col">
            {/* Header */}
            ...
            {/* Type Switch Tabs */}
            <div className="grid grid-cols-2 p-2 gap-2 bg-slate-100 dark:bg-slate-950 border-b border-slate-200 dark:border-slate-800 shrink-0">
              <button
                type="button"
                ...
                <form onSubmit={handleSaveNewService} className="space-y-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2.5 text-xs font-semibold text-slate-800 dark:text-slate-200 focus:outline-none focus:border-amber-500 cursor-pointer"
                      required
                    >
                      {maquinas.map(m => (
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-xs font-semibold text-slate-800 dark:text-slate-200 focus:outline-none focus:border-amber-500 cursor-pointer"
                        required
                      />
                    </div>
                    <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-xs font-semibold text-slate-800 dark:text-slate-200 focus:outline-none focus:border-amber-500 font-mono"
                        required
                      />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-xs font-semibold text-slate-800 dark:text-slate-200 focus:outline-none focus:border-amber-500"
                    />
                  </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fadeIn">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl w-full max-w-md overflow-hidden shadow-2xl animate-scaleUp">
            ...
            <div className={`px-6 py-4 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between ${
              selectedEvent.type === 'servico' ? 'bg-blue-50/50 dark:bg-blue-950/30' : 'bg-purple-50/50 dark:bg-purple-950/30'
            }`}>
              <div className="flex items-center gap-2">
                  ...
                  return (
                    <div className="space-y-3.5">
                      <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700">
                        ...
                        <h4 className="text-lg font-black text-slate-900 dark:text-slate-100">{s.cliente}</h4>
                        {s.localizacao && (
                          <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">📍 {s.localizacao}</p>
                        )}
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-3 text-xs">
                        <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-700">
                          ...
                          <span className="font-bold text-slate-800 dark:text-slate-200">🚜 {maq?.nome || 'Máquina'}</span>
                        </div>
                        <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-700">
                          <span className="text-[10px] text-slate-400 uppercase font-bold block">Operador</span>
                          <span className="font-bold text-slate-800 dark:text-slate-200">👤 {s.operador_responsavel || 'Jurandir'}</span>
                        </div>
                        <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-700">
                          <span className="text-[10px] text-slate-400 uppercase font-bold block">Horas & Taxa</span>
                          <span className="font-bold text-slate-800 dark:text-slate-200">{s.tempo_horas}h × {formatCurrency(s.valor_hora)}</span>
                        </div>
                        <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-700">
                      ...
                      {s.descricao_servico && (
                        <div className="text-xs p-3 rounded-xl bg-slate-50 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-700">
                          <span className="text-[10px] text-slate-400 uppercase font-bold block mb-0.5">Descrição</span>
                          <p className="text-slate-700 dark:text-slate-300">{s.descricao_servico}</p>
                        </div>
                      )}
                      ...
                      <div className="flex items-center gap-2 pt-2">
                        ...
                        <Button
                          variant="outline"
                          className="flex-1 text-xs font-bold text-emerald-600 dark:text-emerald-400 border-emerald-500/30 hover:bg-emerald-500/10"
                          onClick={() => {
                  ...
                  return (
                    <div className="space-y-3.5">
                      <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700">
                        ...
                        <h4 className="text-lg font-black text-slate-900 dark:text-slate-100">{m.titulo}</h4>
                        <span className="text-xs font-bold text-purple-600 dark:text-purple-400 mt-1 inline-block">
                      ...
                      <div className="grid grid-cols-2 gap-3 text-xs">
                        ...
                        <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-700">
                          ...
                          <span className="font-bold text-slate-800 dark:text-slate-200">{m.mecanico_responsavel || 'Não informado'}</span>
                        </div>
                        <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-700">
                          <span className="text-[10px] text-slate-400 uppercase font-bold block">Horímetro Registro</span>
                          <span className="font-bold text-slate-800 dark:text-slate-200">{m.horimetro_momento}h</span>
                        </div>
                      </div>
                      ...
                      {m.descricao_pecas && (
                        <div className="text-xs p-3 rounded-xl bg-slate-50 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-700">
                          ...
                          <p className="text-slate-700 dark:text-slate-300">{m.descricao_pecas}</p>
                        </div>
                      )}

                      <div className="flex items-center justify-between p-3.5 rounded-xl bg-purple-500/10 border border-purple-500/30">
                        <span className="text-xs font-bold text-slate-700 dark:text-slate-300">Custo da Manutenção</span>
                      ...
                      <div className="flex items-center gap-2 pt-2">
                        ...
                        <Button
                          variant="ghost"
                          size="icon"
                          className="text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 ml-auto"
                          onClick={async () => {
