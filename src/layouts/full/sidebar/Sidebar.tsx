  ...
  return (
    <>
      <div className="xl:block hidden">
        <aside
          className="fixed menu-sidebar w-[270px] h-full bg-white dark:bg-slate-900 rtl:pe-4 rtl:ps-0 top-0 border-r border-slate-200 dark:border-slate-800 flex flex-col justify-between"
          aria-label="Sidebar"
        >
          <div className="px-6 py-4 flex items-center sidebarlogo shrink-0 border-b border-slate-100 dark:border-slate-800/60">
            <FullLogo />
          </div>
